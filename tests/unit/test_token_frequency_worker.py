...
from ldaca_web_app_backend.core.worker_tasks_token import \
...
def test_token_frequency_worker_emits_early_progress_updates(tmp_path, monkeypatch):
    ...
    assert progress_updates[-1] == (1.0, "Token frequency analysis completed")    assert progress_updates[-1] == (1.0, "Token frequency analysis completed")