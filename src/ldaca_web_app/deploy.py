...
def start_frontend(
    ...
    To use IPython display features, install optional dependencies:
        pip install ldaca-web-app[deploy]
    """
    global _nginx_proc
    ...
    if not IPYTHON_AVAILABLE and not ON_COLAB:
        ...
        print(
            "To enable full Jupyter integration, install: pip install ldaca-web-app[deploy]"
        )
    ...
    nginx_template = resources.files("ldaca_web_app.resources").joinpath(
